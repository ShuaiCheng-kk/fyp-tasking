...
export async function POST(req: NextRequest) {
  try {
    ...
    const { company_id, actor_id, action, target_id, target_name, detail } = body
    ...
    await activityLogService.log({ company_id, actor_id, action, target_id, target_name, detail })
