                                  ...
                                  {isExpanded && task.assignee_name && task.assigned_user_id && (
                                    <div style={{ marginTop: 10, paddingTop: 10, borderTop: '1px solid #F1F5F9' }}>
                                      <button
                                        ...
                                        onClick={(e) => {
                                          e.stopPropagation()
                                          router.push(`/partner/communication?tab=messages&partner_id=${task.assigned_user_id}&prefill=${encodeURIComponent(`Regarding: "${task.title}"`)}`)
                                        }}
                        ...
                        <div key={deptId}>
                          ...
                          {rows.map((row, i) => (
                            ...
                            >
                              ...
                              <button
                                onClick={() => router.push(`/partner/communication?tab=messages&partner_id=${row.user_id}`)}
