...
export default function RecruitmentPage() {
  const features = [
    { icon: <IcoPost />, name: 'Post & Manage Job Openings', desc: 'Publish roles to a public recruitment page in minutes. Set recurring schedules, duplicate existing postings, or archive completed ones — all from one place.' },
    { icon: <IcoUsers />, name: 'Smart Applicant Management', desc: 'Review every applicant, see AI-ranked recommendations, and send invitations with one click. The job closes automatically the moment someone accepts.' },
    { icon: <IcoClock />, name: 'Shift Scheduling Controls', desc: 'Visualize each worker\'s daily shift segments with split shift timeline, block back-to-back schedules with clopening detection, and set acceptance deadlines so shifts never go unconfirmed.' },
    { icon: <IcoList />, name: 'Sub-tasks & Attachments', desc: 'Break each shift down into a checklist of duties and attach any relevant documents directly to the job posting.' },
    { icon: <IcoCalendar />, name: 'Staff Availability & Skills', desc: 'See exactly when workers are free and match them to roles that fit their experience — before you even send the invitation.' },
    { icon: <IcoSearch />, name: 'Search & Filter', desc: 'Find the right candidate fast with powerful search and filter across your entire applicant pool.' },
    { icon: <IcoUndo />, name: 'Reverse Actions', desc: 'Made a wrong move? Undo your last action instantly and get back on track without starting over.' },
    { icon: <IcoGlobe />, name: 'Public Recruitment Portal', desc: 'Casual workers and job seekers can browse open positions and apply without needing an account — lowering the barrier to finding great people.' },
  ];

  const steps = [
    { n: '01', title: 'Post', desc: 'Publish your job opening to the public recruitment page. Casual workers and applicants can browse and apply instantly.' },
    { n: '02', title: 'Review', desc: 'See every applicant ranked by AI recommendation. Skills, availability, and work history — all surfaced automatically.' },
    { n: '03', title: 'Invite', desc: 'Select your candidate and send the invitation. The 12-hour acceptance window starts automatically.' },
    { n: '04', title: 'Confirm', desc: 'Candidate accepts, job closes, worker is assigned to the shift. Done.' },
  ];
    ...
    <>
      ...
      <section className="sub-section" style={{ background: '#1C1C1E', padding: '96px 0 80px' }}>
        <div className="sub-inner" style={{ ...inner, textAlign: 'center' }}>
          <span style={{ display: 'inline-block', background: 'rgba(249,115,22,0.18)', color: '#FB923C', padding: '5px 14px', borderRadius: '100px', fontSize: '0.8125rem', fontWeight: 600, fontFamily: 'var(--font-body)', marginBottom: '24px' }}>Recruitment</span>
          ...
          <p style={{ fontFamily: 'var(--font-body)', fontSize: '1.0625rem', color: 'rgba(255,255,255,0.65)', lineHeight: 1.75, maxWidth: '520px', margin: '0 auto 36px' }}>
            From job posting to confirmed hire — without the back-and-forth.
          </p>
      ...
      <section className="sub-section" style={{ background: '#FFFBF5', padding: '80px 0' }}>
        <div className="sub-inner" style={inner}>
          <div style={{ textAlign: 'center', marginBottom: '52px' }}>
            <h2 className="sub-h2" style={h2style}>Everything you need to hire casual workers</h2>
            <p style={subtitleStyle}>Every feature in this module exists because SMEs asked for it.</p>
          </div>
      ...
      <section className="sub-section" style={{ background: '#FFFFFF', padding: '80px 0' }}>
        <div className="sub-inner" style={inner}>
          <div style={{ textAlign: 'center', marginBottom: '60px' }}>
            <h2 className="sub-h2" style={h2style}>From open role to confirmed hire in four steps.</h2>
            <p style={subtitleStyle}>A complete hiring flow — built specifically for casual workforce management.</p>
          </div>
      ...
      {/* ========== FINAL CTA ========== */}
      <CtaBanner headline="Your next hire is one post away." sub="Join SMEs already using Tasking to fill shifts faster and smarter." />
    </>
  );
}
