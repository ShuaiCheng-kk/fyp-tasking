      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 8 }}>
        {assignee ? (
          <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
            <div className="task-card-icon" style={{ width: 22, height: 22, borderRadius: '50%', background: '#F0FDF4', border: '1.5px solid #16A34A', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
          ...
          >
            ...
            <div style={{ padding: '20px 24px', display: 'flex', flexDirection: 'column', gap: 16, maxHeight: 'calc(90vh - 140px)', overflowY: 'auto' }}>
              ...
              <div>
                ...
                <DropdownField value={editShiftId} options={editShiftDropdownOptions} onChange={v => { setEditShiftId(v); const s = editAssigneeShiftOptions.find(x => x.id === v); if (s) setEditDeadlineTime(s.end_time.slice(0, 5)) }} placeholder={editAssignee ? 'Select shift' : 'Select assignee first'} disabled={!editAssignee} />
              </div>
              <div>
                <label style={modalLabelStyle}>
          ...
          <div onClick={e => e.stopPropagation()} style={{ width: 540, background: '#FFFFFF', borderRadius: 20, overflow: 'hidden', boxShadow: '0 24px 64px rgba(0,0,0,0.16)' }}>
            ...
            <div style={{ padding: '20px 24px', display: 'flex', flexDirection: 'column', gap: 14 }}>
              ...
              <div>
                ...
                <DropdownField value={newShiftId} options={newShiftDropdownOptions} onChange={v => { setNewShiftId(v); const s = newTaskShiftOptions.find(x => x.id === v); if (s) setNewDeadlineTime(s.end_time.slice(0, 5)) }} placeholder={newAssigneeId ? 'Select shift' : 'Select assignee first'} disabled={!newAssigneeId} />
              </div>
              <div>
                <label style={modalLabelStyle}>
                  <span style={{ display: 'flex', alignItems: 'center', gap: 5 }}>
