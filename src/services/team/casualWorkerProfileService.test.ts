...
describe('casualWorkerProfileService — CW Detail card certificates', () => {
  ...
  it('returns the certificates the repository resolves for the worker', async () => {
    const certs = [
      { id: 'c1', user_id: 'cw-1', name: 'Food Hygiene Certificate', certificate_url: 'https://x/food.pdf', created_at: '2026-07-01T00:00:00Z' },
      { id: 'c2', user_id: 'cw-1', name: 'First Aid Certificate (CPR + AED)', certificate_url: null, created_at: '2026-07-02T00:00:00Z' },
    ]
