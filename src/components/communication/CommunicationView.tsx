...
export default function CommunicationView({ renderSidebar, basePath }: {
  ...
  useEffect(() => {
    ...
    setPendingPrefill('')
    window.history.replaceState({}, '', `${basePath}/communication`)
  ...
  return (
    <div style={{ display: 'flex', height: '100vh', background: '#F7F8FA', color: '#0F172A' }}>
      ...
      {renderSidebar({ unreadMessages, unreadAnnouncements: unreadAnnCount })}
