...
1. **Module 9 — Account & Authentication** (UC71–77) — foundation; nothing else works without registration/login/company creation.
...
5. **Module 5 — Attendance** (UC49–58) — clock in/out and the approval chain depend on shift assignment existing.
...
7. **Module 6 — Communication** (UC59–62) — independent; announcements and messages.
8. **Module 8 — Settings & Billing** (UC66–70) — multi-company switching and subscription management, gated onto features that already exist by this point.
9. **Module 7 — Report** (UC63–65) — downstream consumer of Shift/Task/Attendance data; build last.
